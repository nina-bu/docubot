...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic DocumentBotSuccessTopic() {
        return buildTopic(ETopics.DOCUMENT_BOT_SUCCESS.getTopic());
    }

    @Bean
    public NewTopic DocumentBotFailTopic() {
        return buildTopic(ETopics.DOCUMENT_BOT_FAIL.getTopic());
    }
